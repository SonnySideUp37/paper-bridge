...
import { Camera, ChevronRight, FileCheck } from "lucide-react";
...
export default function History() {
  ...
  return (
    <main className="mx-auto max-w-md space-y-6 px-5 pb-8 pt-4">
      ...
      <header className="space-y-1">
        <h1 className="font-serif text-[34px] font-semibold leading-tight">{t("history")}</h1>
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted">
                  {new Date(r.createdAt).toLocaleDateString(locale)} · {t("items", { n: r.itemCount })}
                </p>
              </div>
